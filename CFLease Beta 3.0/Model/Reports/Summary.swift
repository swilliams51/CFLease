...
func textForInvestorReport(aLease: Lease, currentFile: String, maxChars: Int) -> String {
...
func textForCustomerReport(aLease: Lease, currentFile: String, includeRate: Bool, maxChars: Int) -> String {
...
func textForLeaseBalance(aLease: Lease, currentFile: String, maxChars: Int) -> String {
    ...
    let str_ln_Title = sectionTitle(strTitle: "Lease Balance Quote", aLeadFollow: "_", maxChars: maxChars)
    ...
    let days: Int = daysBetween(start: lastPaymentDate, end: modDate)
