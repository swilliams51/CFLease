...
//  CFLease Beta 3.0
//
//  Created by Steven Williams on 12/9/21.
//
...
func setAmortizationsFromCashflow(aCashflows: Cashflows, decAnnualRate: Decimal, aDayCount: DayCountMethod) -> Amortizations {
