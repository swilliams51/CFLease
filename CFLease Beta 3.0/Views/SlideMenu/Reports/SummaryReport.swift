                ...
                NavigationView {
                    VStack {
                        ...
                        ScrollView (.vertical, showsIndicators: false) {
                            Text(textForInvestorReport(aLease: myLease, currentFile: currentFile, maxChars: maxChars))
                                .font(self.myFont)
...
struct SummaryReportView_Previews: PreviewProvider {
    static var previews: some View {
        SummaryReport(myLease: Lease(aDate: today()), currentFile: .constant("file is new"), isDark: .constant(false), isPad: .constant(false))
